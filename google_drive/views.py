...
class GoogleDeiveConnect(View):
    template_name = 'drive_files_list.html'

    def get(self, request, *args, **kwargs):
        creds = None
        user=User.objects.filter(email='edtechworxcommunity@gmail.com').first()
        ...
        if not creds or not creds.valid:
            if creds and creds.expired and creds.refresh_token:
                ...
                google_drive_account_instance=GoogleDriveCredentials.objects.filter(drive_email='edtechworxcommunity@gmail.com').first()
